"""
Django settings for noisy_dust_39019 project.
...
ROOT_URLCONF = 'noisy_dust_39019.urls'
...
WSGI_APPLICATION = 'noisy_dust_39019.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_dust_39019 API",
    "DESCRIPTION": "API documentation for noisy_dust_39019 App",
    "VERSION": "v1",
}
